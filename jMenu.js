let listProductsHTML = document.querySelector('.products-container');
let listCartHTML = document.querySelector('.cart-items');
let iconCartSpan = document.querySelector('.cart-icon span');
let cartTotalSpan = document.querySelector('#cart-total');
            ...
            if (positionProduct >= 0) {
                ...
                if (listCartHTML) {
                    ...
                    newCart.innerHTML = `
                        ...
                        <button class = "remove" data-id="${cart.product_id}">Remove</button>
                    `;
